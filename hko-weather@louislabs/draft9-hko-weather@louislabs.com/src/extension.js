...
const HkoWeatherPanel = GObject.registerClass(
  class HkoWeatherPanel extends PanelMenu.Button {
    _init() {
      super._init(0.5);
...
class HkoWeatherPanelContainer {
  constructor() {
    this.container = new HkoWeatherPanel();
  }
...
function enable() {
  hko_weather_panel = new HkoWeatherPanelContainer();
