...
function addComboRow(label, choices, setting, group, configHandler) {
  ...
  let row = new Adw.ComboRow({
    title: label,
    model: choices,
    selected: configHandler[setting],
  });
...
function buildPrefsWidget3() {
  ...
  choices.push(_('Fast'));
  addPref3(
    buildDropDown3('refreshRate', _('Refresh speed'), choices, configHandler),
    group,
  );
  addPref3(
    buildColorButton3('meterFGColor', _('Meter color'), configHandler),
    group,
  );
  addPref3(
    buildSwitch3(
  ...
  addPref3(
    buildSwitch3('show-cpu', _('Show the CPU monitor'), configHandler.settings),
    group,
  );
  choices = [];
  ...
  addPref3(
    buildDropDown3('cpuDisplay', _('Show as'), choices, configHandler),
    group,
  );
  addPref3(
    buildSwitch3('cpu-show-cores', _('Show each core'), configHandler.settings),
    group,
  );
  frame.add(group);
  ...
  choices.push(_('Both meter and value'));
  addPref3(
    buildDropDown3('memDisplay', _('Show as'), choices, configHandler),
    group,
  );
  frame.add(group);
...
function buildPrefsWidget4() {
  ...
  choices.append(_('Fast'));
  addPref4(
    buildDropDown4('refreshRate', _('Refresh speed'), choices, configHandler),
    group,
  );
  addPref4(
    buildColorButton4('meterFGColor', _('Meter color'), configHandler),
    group,
  );
  addPref4(
    buildSwitch4(
  ...
  addPref4(
    buildSwitch4('show-cpu', _('Show the CPU monitor'), configHandler.settings),
    group,
  );
  choices = new Gtk.StringList();
  choices.append(_('Usage meter'));
  ...
  choices.append(_('Both meter and value'));
  addPref4(
    buildDropDown4('cpuDisplay', _('Show as'), choices, configHandler),
    group,
  );
  addPref4(
    buildSwitch4('cpu-show-cores', _('Show each core'), configHandler.settings),
    group,
  );
  frame.append(group);
  ...
  choices.append(_('Both meter and value'));
  addPref4(
    buildDropDown4('memDisplay', _('Show as'), choices, configHandler),
    group,
  );
  frame.append(group);
