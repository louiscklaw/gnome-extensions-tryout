  ...
  class TopHatNetMonitor extends Monitor.TopHatMonitor {
    _init(configHandler) {
      ...
      let gicon = Gio.icon_new_for_string(
        `${Me.path}/icons/net-icon-symbolic.svg`,
      );
    ...
    _refreshCharts() {
      ...
      let netIn = Shared.bytesToHumanString(
        Math.round(bytesInDelta / timeDelta),
        this.network_unit,
      );
      let netOut = Shared.bytesToHumanString(
