...
function createIndicator(server_num) {
	...
	_indicators[server_num] = new JenkinsIndicator.JenkinsIndicator(
		settingsJSON['servers'][server_num], 
		_httpSession
	);
	Main.panel.addToStatusArea(
		"jenkins-indicator-"+settingsJSON['servers'][server_num]['id'], 
		_indicators[server_num]
	);
}
